...
{
{ .pin = BSP_IO_PORT_00_PIN_0, .pin_cfg =
          ((uint32_t) IOPORT_CFG_PORT_PERI | (uint32_t) IOPORT_PIN_P000_PFC_00_ETH2_RXD3) },
  { .pin = BSP_IO_PORT_00_PIN_1, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P001_PFC_01_ETH2_RXDV) },
  { .pin = BSP_IO_PORT_00_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P002_PFC_00_ETH2_TXEN) },
  { .pin = BSP_IO_PORT_00_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P003_PFC_01_ETH2_REFCLK) },
  { .pin = BSP_IO_PORT_00_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
  ...
  { .pin = BSP_IO_PORT_00_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P006_PFC_00_ETH2_TXCLK) },
  { .pin = BSP_IO_PORT_01_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P012_PFC_01_ETH2_TXD3) },
  { .pin = BSP_IO_PORT_01_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P013_PFC_00_ETH2_TXD2) },
  ...
  { .pin = BSP_IO_PORT_01_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P015_PFC_00_ETH2_TXD0) },
  ...
  { .pin = BSP_IO_PORT_03_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P037_PFC_02_TRACEDATA5) },
  { .pin = BSP_IO_PORT_04_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_05_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P052_PFC_09_CANRX0) },
  { .pin = BSP_IO_PORT_05_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P053_PFC_0A_CANTX0) },
  ...
  { .pin = BSP_IO_PORT_08_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
  ...
  { .pin = BSP_IO_PORT_10_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_10_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_11_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_11_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_11_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_11_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_11_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
  ...
  { .pin = BSP_IO_PORT_12_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P120_PFC_00_XSPI1_IO7) },
  { .pin = BSP_IO_PORT_12_PIN_1, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P121_PFC_00_XSPI1_IO6) },
  { .pin = BSP_IO_PORT_12_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P122_PFC_00_XSPI1_IO5) },
  { .pin = BSP_IO_PORT_12_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P123_PFC_00_XSPI1_IO4) },
  { .pin = BSP_IO_PORT_12_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P124_PFC_00_XSPI1_RESET0) },
  { .pin = BSP_IO_PORT_12_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P125_PFC_00_XSPI1_IO3) },
  ...
  { .pin = BSP_IO_PORT_12_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P127_PFC_01_XSPI1_IO1) },
  { .pin = BSP_IO_PORT_13_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P130_PFC_00_XSPI1_IO0) },
  { .pin = BSP_IO_PORT_13_PIN_1, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P131_PFC_00_XSPI1_CS0) },
  { .pin = BSP_IO_PORT_13_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  { .pin = BSP_IO_PORT_13_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P133_PFC_00_XSPI1_CKP) },
  { .pin = BSP_IO_PORT_13_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
  ...
  { .pin = BSP_IO_PORT_14_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  ...
  { .pin = BSP_IO_PORT_15_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P153_PFC_00_XSPI0_IO4) },
  { .pin = BSP_IO_PORT_15_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
  ...
  { .pin = BSP_IO_PORT_15_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P155_PFC_00_XSPI0_IO6) },
  { .pin = BSP_IO_PORT_15_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P156_PFC_00_XSPI0_IO7) },
  ...
  { .pin = BSP_IO_PORT_16_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_INPUT) },
  ...
  { .pin = BSP_IO_PORT_18_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P185_PFC_03_SPI_MOSI2) },
  { .pin = BSP_IO_PORT_18_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P186_PFC_05_SPI_MISO2) },
  { .pin = BSP_IO_PORT_18_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P187_PFC_03_SPI_SSL20) },
  { .pin = BSP_IO_PORT_19_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P190_PFC_00_USB_VBUSEN) },
  { .pin = BSP_IO_PORT_19_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_19_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_19_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_19_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_20_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  ...
  { .pin = BSP_IO_PORT_20_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_20_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_20_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P205_PFC_02_IIC_SCL0) },
  { .pin = BSP_IO_PORT_20_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P206_PFC_02_IIC_SDA0) },
  { .pin = BSP_IO_PORT_21_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  { .pin = BSP_IO_PORT_21_PIN_1, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P211_PFC_00_TRACEDATA0) },
  { .pin = BSP_IO_PORT_21_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P212_PFC_00_TRACEDATA1) },
  { .pin = BSP_IO_PORT_21_PIN_3, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P213_PFC_00_TRACEDATA2) },
  { .pin = BSP_IO_PORT_21_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
  ...
  { .pin = BSP_IO_PORT_21_PIN_5, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P215_PFC_01_TRACEDATA4) },
  { .pin = BSP_IO_PORT_21_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P217_PFC_01_TRACEDATA6) },
  { .pin = BSP_IO_PORT_22_PIN_0, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P220_PFC_01_TRACEDATA7) },
  { .pin = BSP_IO_PORT_22_PIN_1, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P221_PFC_00_TRACECTL) },
  { .pin = BSP_IO_PORT_22_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_HIGH | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_CFG_SLEW_RATE_FAST | (uint32_t) IOPORT_PIN_P222_PFC_01_TRACECLK) },
  { .pin = BSP_IO_PORT_22_PIN_6, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P226_PFC_02_IIC_SCL1) },
  { .pin = BSP_IO_PORT_22_PIN_7, .pin_cfg = ((uint32_t) IOPORT_CFG_DRIVE_MID | (uint32_t) IOPORT_CFG_PORT_PERI
          | (uint32_t) IOPORT_PIN_P227_PFC_02_IIC_SDA1) },
  { .pin = BSP_IO_PORT_23_PIN_4, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_DIRECTION_OUTPUT
          | (uint32_t) IOPORT_CFG_PORT_OUTPUT_LOW) },
  ...
  { .pin = BSP_IO_PORT_24_PIN_2, .pin_cfg = ((uint32_t) IOPORT_CFG_PORT_PERI
